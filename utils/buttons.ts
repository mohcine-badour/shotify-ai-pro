...
const ICONS = [
  Config.isIos ? 'scribble' : 'settings',
  Config.isIos ? 'lasso' : 'history',
  Config.isIos ? 'plus.bubble' : 'message',
  Config.isIos ? 'wand.and.stars' : 'contact-support',
...
export const BUTTONS_LIST = [
  { title: 'Settings', icon: ICONS[0], color: COLORS[0] },
  { title: 'History', icon: ICONS[1], color: COLORS[1] },
  { title: 'Message', icon: ICONS[2], color: COLORS[2] },
  { title: 'Contact Support', icon: ICONS[3], color: COLORS[3] },
